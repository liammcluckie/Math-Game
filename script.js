...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // Allows the user to press the enter button to submit
...
// Math.floor rounds to the whole number
// Math.random generates random numbers

document.getElementById("answer-box").value = ""; // Empties the value box
document.getElementById("answer-box").focus(); // Cursor automatically in the answer box
...
let num2 = Math.floor(Math.random() * 25) + 1;
    ...
    if (gameType === "addition") {
        ...
        throw `Unknown game type ${gameType}, aborting!`; // Print error to console
    }
}
...
function displaySubtractQuestion(operand1, operand2) {
    // Check whether operand1 is bigger than operand2
